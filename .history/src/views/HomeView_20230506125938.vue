<template>
  <main class="container text-white">
    ...
    <div class="search-box pt-10  mb-8 relative px-12 md:px-14 lg:px-32">
      ...
      <i class="fas fa-dot-circle absolute right-36 top-16 cursor-pointer" @click="currentCity"></i>
      ...
      <!-- Map -->
      <Map :lng="lon" :lat="lat" @find-my-loc="currentCity"/>
      <!-- map -->
    </div>
...
export default {
  ...
  methods: {
    ...
    currentCity() {
      console.log('current cityy called')
